...
public class Vector3i {
    ...
    public boolean closerThan(IPosition p_218137_1_, double p_218137_2_) {
        return this.distSqr(p_218137_1_.getX(), p_218137_1_.getY(), p_218137_1_.getZ(), true) < p_218137_2_ * p_218137_2_;
    }
    ...
    public double distSqr(IPosition p_218138_1_, boolean p_218138_2_) {
        return this.distSqr(p_218138_1_.getX(), p_218138_1_.getY(), p_218138_1_.getZ(), p_218138_2_);
    }
